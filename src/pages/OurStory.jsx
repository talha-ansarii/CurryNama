...
const OurStory = () => {
  ...
  <img src='/HomePage/TOP3.jpg' alt='paneer' className='rounded-[4px] md:rounded-[10px] lg:rounded-[10px] lg:w-[365px] lg:h-[265px] object-cover mt-4 md:mt-[20px] lg:mt-[20px] shadow-md'/>
        ...
        <div className='flex gap-10 my-10 md:my-12 lg:my-12'>
...
The journey continued with the opening of outlets in Gurgaon on May 18, 2022, Noida on November 18, 2022, and finally, Preet Vihar on December 26, 2022. Each new location added to the growing list of loyal customers who couldn't get enough of Currynama's delicious offerings.
        ...
        <div className='flex gap-10 my-10 md:my-12 lg:my-12'>
            ...
            <div className='w-[50%] flex flex-col justify-start '>
                <div className='teko font-[600] text-[20px] md:text-[40px] leading-[23px] md:leading-[40px] lg:leading-[40px] text-[#DA3D12]'>The Road Ahead </div>
...
With each outlet, Currynama brings the rich heritage of Indian flavours and the promise of quality that Seven Seas Hotel is known for. The story of Currynama is one of passion, dedication, and a relentless pursuit of culinary perfection.
        ...
        <div className='flex gap-10 my-10 md:my-12 lg:my-12'>
            ...
            <div className='w-[40%] flex flex-col justify-start '>
                <div className='teko font-[600] text-[20px] leading-[23px] md:leading-[40px] lg:leading-[40px] text-[#DA3D12] md:text-[40px]'>Top-Selling Delicacies</div>
                <div className='montserrat font-[600]  lg:text-[18px] lg:leading-[20px] md:text-[10px] md:leading-[12px] text-[#1C6360] text-[5px] leading-[6px]'>Currynama's menu is a treasure trove of Indian flavours, with several dishes becoming absolute favourites among its patrons. The top-selling items include:<br/><br />
