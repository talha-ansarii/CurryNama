...
const OurStory = () => {
  return (
    ...
    <Navbar/>
        ...
        <div className='teko font-[700] text-[40px] lg:text-[60px] lg:leading-[60px] mt-12 md:text-[60px] text-center text-[#DA3D12]'>The Story of Currynama: A Culinary Journey by Seven Seas Hotel</div>
        ...
        <div className='flex gap-10 my-20'>
            ...
            <div className='w-[50%] flex flex-col justify-start '>
                <div className='teko font-[600] text-[20px] md:text-[40px] text-[#1C6360]'>From Humble Beginnings to Culinary Excellence </div>
                <div className='montserrat font-[600] lg:text-[20px] lg:leading-[24px] md:text-[15px] md:leading-[18px] text-[#1C6360] text-[7px] leading-[9px]'>The journey of Currynama began with opening its first outlet in Rohini on August 27, 2021. From day one, Currynama aimed to bring the authentic taste of Indian cuisine to the doorstep of its customers, ensuring every meal is prepared with the highest standards of quality and hygiene. The overwhelming response from Rohini’s outlets set the stage for Currynama’s rapid expansion.  </div>
            </div>
        </div>
        <div className='flex gap-10 my-20'>
            <div className='w-[50%] flex flex-col justify-start '>
                <div className='teko font-[600] text-[20px] md:text-[40px] text-[#1C6360]'>Expansion and Milestones </div>
                <div className='montserrat font-[600] lg:text-[20px] lg:leading-[24px] md:text-[15px] md:leading-[18px] text-[#1C6360] text-[7px] leading-[9px]'>Following the success of Rohini, Currynama opened its second outlet in LR (Lawrence Road) on October 16, 2021. The new outlet quickly became popular, further establishing Currynama's reputation for delivering mouth-watering dishes. Encouraged by this success, the third outlet was launched in GK (Greater Kailash) on January 7, 2022, bringing the flavours of Currynama to a new audience.<br/>
...
With each outlet, Currynama brings the rich heritage of Indian flavours and the promise of quality that Seven Seas Hotel is known for. The story of Currynama is one of passion, dedication, and a relentless pursuit of culinary perfection.
        ...
        <div className='flex gap-10 my-20'>
            ...
            <div className='w-[40%] flex flex-col justify-start '>
                <div className='teko font-[600] text-[20px] text-[#1C6360] md:text-[40px]'>Top-Selling Delicacies</div>
                <div className='montserrat font-[600] lg:text-[20px] lg:leading-[24px] md:text-[15px] md:leading-[18px] text-[#1C6360] text-[7px] leading-[9px]'>Currynama's menu is a treasure trove of Indian flavours, with several dishes becoming absolute favourites among its patrons. The top-selling items include:<br/>
- <b>  Kakori Kebab Taco: </b> Savor the fusion of flavours with our Kakori Kebab Taco, where succulent, spiced kebabs meet the crisp freshness of a taco shell.<br/>
- <b>Gur Rasgulla: </b> Indulge in the rich, caramelised sweetness of our traditional Gur Rasgulla, a delightful twist on the classic Indian dessert.<br/>
- <b> Teh Pe Teh Paneer Tikka:</b> A layered paneer tikka that is a delight for vegetarians and a favourite at every gathering.<br/>
- <b>Dal Seven Seas:</b> A signature lentil dish that embodies the essence of comfort food, perfect for any meal.<br/>
-<b>Butter Chicken:</b>  An all-time favourite, this creamy and savoury chicken dish has won hearts across all outlets.<br/>
