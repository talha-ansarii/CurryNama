...
import { FaPhoneVolume, FaLocationDot, FaTwitter } from "react-icons/fa6";
...
const ContactUs = () => {
  ...
  return (
    <div className="bg-[white] w-full min-h-[100vh] ">
      <Navbar />
      <div className="pt-[89.98px] h-[100%] px-12">
        <div className="w-full flex justify-center items-center flex-col">
          <div>
            <div className="teko pt-8 text-[40px] md:text-[20px] lg:text-[55px] leading-[40px] md:leading-[20px] lg:leading-[55px] text-[#DA3D12] text-font-blue text-center">
              Contact Us
            </div>
            <div className="text-center text-[#DA3D12] montserrat font-bold mt-2 text-[20px]">
              Any question or remarks? Just write us a message!
            </div>
          </div>
          <div className="w-[99%] relative flex flex-col md:flex-row lg:flex-row gap-10 bg-[#FAB70017] h-[100%] md:h-[667px] lg:h-[667px] md:p-2 lg:p-2 p-2 pt-2 pb-12 rounded-md mt-10">
            <div className="relative text-center md:text-left lg:text-left flex flex-col justify-between w-[99%] lg:w-[40%] md:w-[40%] md:h-[647px] gap-12 md:gap-0 lg:gap-0 lg:h-[647px] overflow-hidden bg-[#DA3D12] rounded-md p-6">
              
              <div className=" md:w-[200px] md:h-[200px] md:bottom-[-15%] md:right-[-20%]  hidden md:block lg:block absolute lg:bottom-[-15%] lg:right-[0%] lg:w-[269px] lg:h-[269px] rounded-full z-10 ">
                <img src="/ContactUs/1.png" alt="contact" className="lg:w-[220px] lg:h-[167px] md:w-[136px] md:h-[104px] object-cover" />
              </div>
              ...
              <div className="flex z-30 relative gap-2 justify-center md:justify-start lg:justify-start">
                ...
                <div className="bg-black group w-[30px] h-[30px] hover:bg-white cursor-pointer rounded-full flex items-center justify-center">
                  <FaTwitter className="text-white w-[15px] h-[15px] group-hover:text-black" />
                </div>
              </div>
            </div>
            {/* right div */}
              ...
              <form onSubmit={handleSubmit}>
                <div className="flex flex-col md:grid lg:grid md:grid-cols-2 lg:grid-cols-2 gap-12">
                  ...
                  >
                    <p>First Name</p>
                    <input
                      className="focus:outline-none bg-transparent focus:border-b focus:ring-0 border-b border-b-black"
                      id="Fname"
                      type="text"
                      placeholder=""
                      value={name}
                ...
                <div className="w-full col-span-2 flex justify-center">
                  <button
                    type="submit"
                    className="bg-[#DA3D12] text-white w-[174px] h-[50px] rounded-[5px] mt-4 shadow-black shadow-md hover:shadow-none transition-all ease-out duration-300"
                  >
                    Submit
                  </button>
                </div>
