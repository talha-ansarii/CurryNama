...
function Card() {
  return (
    ...
    <div>
        <img src='/HomePage/butterChicken.jpeg' alt='butter-chicken' className='w-[65px] h-[65px] md:w-[113px] md:h-[113px] rounded-full top-[-25px] md:top-[-50px] object-cover left-[50%] translate-x-[-50%] absolute imgShadow lg:w-[187px] lg:h-[187px] lg:top-[-70px] '  />
    </div>
