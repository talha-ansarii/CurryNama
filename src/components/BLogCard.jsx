...
const BlogCard = ({blog}) => {
  ...
  return (
    <div className="max-w-sm rounded-lg overflow-hidden cursor-pointer p-4">
      ...
      <div className="pt-4">
        <h2 className="text-[12px] leading-[14px] md:text-[20px] md:leading-[24px] lg:text-[20px] lg:leading-[24px] font-[600] text-[#1C6360] montserrat"><p dangerouslySetInnerHTML={{ __html: blog.title }}></p> </h2>
